...
import { StyleSheet, Text, View, Image, Button, Modal, Pressable } from 'react-native';
...
const Screen02 = ({ route, navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.info}>Email: {email}</Text> {/* Hiển thị email */}
            <Text style={styles.info}>Password: {password}</Text> {/* Hiển thị password */}
