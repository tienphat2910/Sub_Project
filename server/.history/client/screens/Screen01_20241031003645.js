import { StyleSheet, Text, View, ScrollView, Image, TextInput, FlatList, TouchableOpacity, SafeAreaView } from 'react-native';
...
const Screen01 = ({ route, navigation }) => { // Nhận navigation từ props
    ...
    const handleAvatarPress = () => {
        navigation.navigate('Screen02', { name, avatar, email, password });
    };

    const handleProfilePress = () => {
        navigation.navigate('Screen02', { name, avatar, email, password }); // Điều hướng khi nhấp vào Profile
    };
