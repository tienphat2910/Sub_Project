      ...
      {step === 2 && (
        <>
          ...
          <View style={styles.passwordContainer}>
            ...
            />
            <TouchableOpacity onPress={() => setShowConfirmPassword(!showConfirmPassword)} style={styles.iconToggle}>
              <Image
                source={showConfirmPassword ? require('../assets/icons/opened_eye.png') : require('../assets/icons/closed_eye.png')}
                style={styles.icon}
              />
            </TouchableOpacity>
          </View>
