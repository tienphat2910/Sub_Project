...
const ForgotPasswordScreen = ({ navigation }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                setShowNewPasswordModal(true); // Hiện modal nhập mật khẩu mới
            } else {
    ...
    const handleNewPasswordSubmit = async () => {
        ...
        // Gửi mật khẩu mới đến server (cập nhật ở đây với API cụ thể)
        try {
            ...
            setModalVisible(true); // Hiện modal thông báo
        }
    };
